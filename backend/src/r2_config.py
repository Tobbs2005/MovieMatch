...
def load_data_with_fallback_simple(max_movies=15000):
...
Please either:
1. Set up Cloudflare R2 with environment variables:
   - CLOUDFLARE_ACCOUNT_ID
   - R2_ACCESS_KEY_ID
   - R2_SECRET_ACCESS_KEY
   - R2_BUCKET_NAME

2. Or place data files in the backend/src/data/ directory:
   - TMDB_movie_dataset_v11.csv
   - movie_embeddings_v11.npy

This backend requires real movie data to function properly.
        """)
